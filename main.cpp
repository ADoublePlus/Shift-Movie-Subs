...
void displayHowTo()
{
    cout << endl << "How to use it:"
         ...
         << endl << "\t-s\tFor positive or negative shift. The number of seconds to add or subtract."
...
int main(int argc, char* argv[])
{
    ...
    cout << endl << endl << "Shift operation completed successfully with " << subCount << subCount <<" subtitles shifted." << endl;
